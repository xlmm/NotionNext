...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '深度生活观察者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.lucasxu.life', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,产品沉思,游戏设计', // 网站关键词 英文逗号隔开
